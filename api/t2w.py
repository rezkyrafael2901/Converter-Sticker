...
def handler(request):
    ...
    data = out.getvalue()
    return {'statusCode':200,'headers':{'Content-Type':'image/webp','Content-Disposition':'attachment; filename=whatsapp_sticker.webp'}, 'body': base64.b64encode(data).decode('ascii'), 'isBase64Encoded': True}
